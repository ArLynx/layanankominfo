<x-admin-layout title="Tambah User">
    <div class="mb-6">
        <h1 class="text-headline-large font-bold text-on-surface">Tambah User Baru</h1>
        <p class="mt-1 text-on-surface-variant">Buat akun pengguna biasa baru</p>
    </div>

    <form method="POST" action="{{ route('admin.users.store') }}" class="bg-surface-container-lowest rounded-xl border border-border-subtle p-6 space-y-6 max-w-2xl">
        @csrf
