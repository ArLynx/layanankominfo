<x-pimpinan-layout title="Persetujuan Email Satuan Kerja">
    ...
    <header class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-border-subtle pb-6">
        <div>
            ...
            <p class="text-body-md font-body-md text-on-surface-variant">Daftar pengajuan email satuan kerja yang menunggu persetujuan Anda</p>
        </div>
    </header>
                    ...
                    @forelse ($emailSatkers as $item)
                        <tr class="border-b border-border-subtle hover:bg-surface-gray/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('pimpinan.email-satker.approval-show', $item) }}"
