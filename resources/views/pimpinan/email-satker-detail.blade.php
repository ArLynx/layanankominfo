<x-pimpinan-layout title="Detail Pengajuan Email Satuan Kerja">
    <header class="flex items-start md:items-center justify-between border-b border-border-subtle pb-6">
        <div>
            ...
            <p class="text-body-md font-body-md text-on-surface-variant">Informasi dan dokumen pengajuan email satuan kerja</p>
        </div>
    </header>
            ...
            <div class="bg-surface rounded-xl border border-border-subtle p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium">{{ $emailSatker->nama_penanggung_jawab }}</p>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500">Instansi</label>
                        <p class="font-medium">{{ $emailSatker->nama_instansi }}</p>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500">Akun Dinas</label>
                    ...
                    <div>
                        ...
                        @php
                            $statusLabel = match($emailSatker->status) {
                                ...
                                default => [$emailSatker->status, 'text-gray-600'],
                            };
                        @endphp
